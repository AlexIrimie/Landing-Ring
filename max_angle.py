...
max_dis = float(input("Enter the max displacement of the center of the ring in inches: "))
max_dis = max_dis / 12

phi = math.degrees(math.asin(max_dis / float(radius)))

print(f"The max angle from the horizontal you can get is {phi}")
